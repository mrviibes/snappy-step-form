...
// Get model from environment with fallback - Always use GPT-5 Mini (fast and efficient)
const getTextModel = () => Deno.env.get('OPENAI_TEXT_MODEL') || 'gpt-5-mini-2025-08-07';
