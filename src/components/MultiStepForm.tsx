...
const steps = [
  { id: 1, title: "Category", component: CategoryStep },
  { id: 2, title: "Text", component: TextStep },
  { id: 3, title: "Visuals", component: VisualsStep },
  { id: 4, title: "Your Vibe", component: VibeStep },
];
...
export default function MultiStepForm() {
  ...
  const [formData, setFormData] = useState<FormData>({
    category: "",
    text: { name: "", goal: "" },
    visuals: { style: "", colors: [] },
    vibe: { intensity: "", personality: "" },
  });
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground">
            Tell us about yourself in 4 easy steps
          </p>
        </div>
